...
function Footer() {
  return (
    <div className='bg-black p-7 '>
      <footer className="">
        <div className="flex flex-col md:flex-row text-black justify-between items-start
        bg-white rounded-md p-5    h-72">
          <div className="mb-4 md:mb-0 ">
            ...
            <div className="flex mt-40 space-x-2.5 ">
      ...
      <div class="bg-black mt-8 py-4 text-white flex justify-between  mr-14">

        <h1 className="text-4xl  text-left font-bold">Your Startup. Our Platform. <br /> Together, We Build the Future</h1>
        <div class="flex flex-col justify-center mt-4">
          <Heading className="text-sm text-white mb-2.5" text="Just send us your contact email and we will contact you. " />
          <div>
            <input type="email" placeholder="Your Email" className="bg-black rounded-lg text-white px-4 w-96 border-[1px] border-white py-2 focus:outline-none focus:ring-2 focus:ring-gray-600" />
            <button className=" text-white -ml-5 ">→</button>
          </div>
