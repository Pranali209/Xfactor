...
function Acceration() {
    ...
    return (
        <div className='py-16 '>
            <Heading className="text-center font-semibold text-5xl text-black" as="h1" text="Acceleration Programme" />
            <Heading className="text-center text-lg mt-5 text-black" as="p" text="Built for Bold Startups Ready to Lead the Future." />
            ...
            <Heading className="text-center text-lg mt-5 text-black" as="p" text="Everything You Need to Scale and Succeed." />
            {
            ...
            <div className='mx-auto my-16 relative'>
                <div className='flex  items-center justify-center'>
                    <Heading className="text-center font-semibold  text-4xl text-black " as="h1" text="Who Is This For ?" />
                    <img src={Emoji} className='ml-1 w-16 ' />
                </div>

                <Heading className="text-center -ml-7 text-[19px] mt-5 text-black" as="p" text="We are Looking for the Game-Changers." />
                <div className='flex flex-col justify-center items-center my-5'>
                    <ul className="list-disc ml-10 mt-5 list-inside  text-base text-black">
                        <Heading className=" text-lg mt-5 text-black" as="p" text="The X-Factor Acceleration Program is designed for startups with:" />
                        <li className=" ml-8 text-[17px] mt-5 text-black">A bold, disruptive idea</li>
                        <li className="ml-8  text-[17px] mt-5 text-black">A vision to solve meaningful challenges</li>
                        <li className="ml-8  text-[17px] mt-5 text-black">The drive to scale and make an impact.</li>
                    </ul>
            ...
            <Heading className="text-center font-medium  text-4xl text-black " as="h1" text="Startups That Have Found Their X-Factor." />
             <div className='flex justify-evenly items-center my-16'>
                <BoxA className= "w-52 py-12 boxShadow" htxt="" ptxt="Highlight testimonials or case studies"/>
                <BoxA className= "w-52 py-12 boxShadow" htxt="" ptxt="Highlight testimonials or case studies"/>
             </div>
            </div>
            <div className='my-28 w-[60%] mx-auto  relative'>
            <Heading className="text-center font-medium  text-4xl text-black " as="h1" text="Ready to Accelerate Your Vision?" />
